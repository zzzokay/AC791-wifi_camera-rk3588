...
#define SPI_CAMERA_W						CONFIG_VIDEO1_IMAGE_W //摄像头的分辨率-宽，需要和摄像头驱动设置的输出分辨率寄存器配置一致
#define SPI_CAMERA_H						CONFIG_VIDEO1_IMAGE_H //摄像头的分辨率-高，需要和摄像头驱动设置的输出分辨率寄存器配置一致
